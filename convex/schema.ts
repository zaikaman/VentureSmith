...
export default defineSchema({
  ...
  startups: defineTable({
    ...
    websitePrototypeEvaluationUrl: v.optional(v.string()),
    ...
    aiWireframeEvaluationUrl: v.optional(v.string()),
    ...
    brainstormABTestIdeasEvaluationUrl: v.optional(v.string()),
    seoStrategy: v.optional(v.string()),
    seoStrategyEvaluationUrl: v.optional(v.string()),
    processAutomation: v.optional(v.string()),
    processAutomationEvaluationUrl: v.optional(v.string()),
    draftJobDescriptions: v.optional(v.string()),
    draftJobDescriptionsEvaluationUrl: v.optional(v.string()),
    investorMatching: v.optional(v.string()),
    investorMatchingEvaluationUrl: v.optional(v.string()),
    dueDiligenceChecklist: v.optional(v.string()),
    dueDiligenceChecklistEvaluationUrl: v.optional(v.string()),
    aiPitchCoach: v.optional(v.string()),
    aiPitchCoachEvaluationUrl: v.optional(v.string()),
    createdAt: v.number(),
