...
export const updateDeepDiveMarketAnalysisEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      deepDiveMarketAnalysisEvaluationUrl: args.url,
    });
...
export const updateBrandIdentityEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      brandIdentityEvaluationUrl: args.url,
    });
...
export const updateScorecardEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
...
export const updatePitchDeckEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      pitchDeckEvaluationUrl: args.url,
    });
...
export const updateCompetitorMatrixEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      competitorMatrixEvaluationUrl: args.url,
    });
...
export const updateCustomerPersonasEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      customerPersonasEvaluationUrl: args.url,
    });
...
export const updateInterviewScriptsEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      interviewScriptsEvaluationUrl: args.url,
    });
...
export const updateCustomerValidationEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      customerValidationEvaluationUrl: args.url,
    });
...
export const updateAIMentorEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      aiMentorEvaluationUrl: args.url,
    });
...
export const updateUserFlowDiagramEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      userFlowDiagramEvaluationUrl: args.url,
    });
...
export const updateAIWireframeEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      aiWireframeEvaluationUrl: args.url,
    });
...
export const updateWebsitePrototypeEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      websitePrototypeEvaluationUrl: args.url,
    });
...
export const updateTechStackEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      techStackEvaluationUrl: args.url,
    });
...
export const updateDatabaseSchemaEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      databaseSchemaEvaluationUrl: args.url,
    });
...
export const updateApiEndpointsEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      apiEndpointsEvaluationUrl: args.url,
    });
...
export const updateDevelopmentRoadmapEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      developmentRoadmapEvaluationUrl: args.url,
    });
...
export const updateCostEstimateEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      costEstimateEvaluationUrl: args.url,
    });
...
export const updatePricingStrategyEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      pricingStrategyEvaluationUrl: args.url,
    });
...
export const updateMarketingCopyEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      marketingCopyEvaluationUrl: args.url,
    });
...
export const updateProductHuntKitEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      productHuntKitEvaluationUrl: args.url,
    });
...
export const updateDraftPressReleaseEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      draftPressReleaseEvaluationUrl: args.url,
    });
...
export const updateIdentifyGrowthMetricsEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      identifyGrowthMetricsEvaluationUrl: args.url,
    });
...
export const updateBrainstormABTestIdeasEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      brainstormABTestIdeasEvaluationUrl: args.url,
    });
...
export const updateSeoStrategyEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      seoStrategyEvaluationUrl: args.url,
    });
...
export const updateProcessAutomationEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      processAutomationEvaluationUrl: args.url,
    });
...
export const updateDraftJobDescriptionsEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      draftJobDescriptionsEvaluationUrl: args.url,
    });
...
export const updateInvestorMatchingEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      investorMatchingEvaluationUrl: args.url,
    });
...
export const updateDueDiligenceChecklistEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      dueDiligenceChecklistEvaluationUrl: args.url,
    });
...
export const updateAIPitchCoachEvaluationUrl = mutation({
  args: {
    startupId: v.id("startups"),
    url: v.string(),
  },
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(args.startupId, {
      aiPitchCoachEvaluationUrl: args.url,
    });
