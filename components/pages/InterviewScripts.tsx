...
export const InterviewScripts: React.FC<InterviewScriptsProps> = ({ startup }) => {
    ...
    return (
      <div className="is-results-container">
        <div className="header-section">
          <h2 className="text-3xl font-bold">Interview Scripts</h2>
  ...
  return (
    <div className="is-initial-view">
      <h2 className="text-3xl font-bold mb-4">Generate Interview Scripts</h2>
      <p className="text-slate-400 mb-8 max-w-2xl mx-auto">Create tailored interview scripts based on your customer personas to effectively validate your problem and solution.</p>
      <button onClick={handleGenerate} disabled={!canGenerate} className="cta-button">Draft Interview Scripts</button>
      {!canGenerate && <p className="text-sm text-slate-500 mt-4">Please complete the Customer Personas step first.</p>}
    </div>
  );
};
