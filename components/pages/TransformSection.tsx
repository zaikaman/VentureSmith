        ...
        <div className="py-20">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
                    <div>
                        <h2 className="text-5xl font-bold leading-tight mb-8">From Vision to Venture: AI-Powered Tools for Every Stage.</h2>
                        <button onClick={scrollToTopAndHighlight} style={{backgroundColor: `var(--primary-color)`}} className="text-white w-16 h-16 rounded-full flex items-center justify-center text-3xl transform rotate-45"> {/* Add onClick */}
                            →
                        </button>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                    <Card 
                        ...
                        description="Quickly assess the viability of your startup ideas with AI-driven validation and scoring."
                    />
                    <Card 
                        ...
                        description="Generate instant website prototypes to visualize your online presence and gather early feedback."
                    />
                    <div style={{backgroundColor: `var(--bg-slate-800)`}} className="p-6 rounded-2xl shadow-lg backdrop-blur-xl h-full flex flex-col justify-between">
                        <div>
                            <div style={{color: `var(--primary-color)`}} className="flex items-center mb-2">
                                <span className="text-3xl font-bold mr-2">AI-Driven</span>
                                <span>Insights</span>
                            </div>
                        ...
                        <p style={{color: `var(--text-slate-400)`}} className="text-sm mt-4">Gain unparalleled insights into market trends, customer behavior, and competitive landscapes.</p>
                    </div>
                </div>
            </div>
        </div>
